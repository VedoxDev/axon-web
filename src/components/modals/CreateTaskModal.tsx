...
const CreateTaskModal: React.FC<CreateTaskModalProps> = ({ isOpen, onClose, onTaskCreated }) => {
  ...
  const createTask = async () => {
    ...
    try {
      ...
      // Create personal task by NOT including projectId
      const taskData = {
        title: newTask.title,
        ...
        // No projectId = personal task according to API docs
      };
      ...
      showError(error instanceof Error ? error.message : 'Error al crear la tarea');
    } finally {
      setIsCreating(false);
    }
  };
    ...
    <>
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-lg rounded-lg shadow-xl z-60 flex flex-col" style={{ backgroundColor: '#161718' }}>
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-600">
          <h2 className="text-xl font-semibold text-white">Nueva Tarea Personal</h2>
          <button
            onClick={onClose}
