...
const ChatPanel: React.FC<ChatPanelProps> = ({ activeChannel, channelType = 'chat' }) => {
    ...
    return (
      <div className="flex-1 bg-gray-900 flex items-center justify-center">
        <div className="text-center text-gray-400">
          ...
          <p>Elige un canal del panel lateral para comenzar a chatear</p>
        </div>
      </div>
    );
  }
        ...
        <div className="p-4 bg-gray-800">
          <div className="relative">
            <input
              ...
              className="w-full bg-gray-700 text-white placeholder-gray-400 rounded-lg px-4 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              value={searchQuery}
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-gray-400">
                    {activeTab === 'chats' ? 'En línea' : `${groups.find(g => g.id === selectedChat)?.name || ''}`}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center space-x-3">
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full bg-gray-700 text-white placeholder-gray-400 rounded-lg px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    value={messageInput}
